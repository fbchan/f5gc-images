...
push:
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_BASE_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_GNBSIM_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_AMF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_SMF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_UPF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_NRF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_AUSF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_NSSF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_PCF_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_UDM_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_UDR_NAME}:${DOCKER_TAG}
	docker push ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/${F5GC_WEBUI_NAME}:${DOCKER_TAG}
